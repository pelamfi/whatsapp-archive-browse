"""
Tests for the parser2 module using ChatData2 structures.
"""

from pathlib import Path

from src.chat_data2 import ChatFile2, ChatName2
...
def test_parse_chat_file_smoke_test(tmp_path: Path) -> None:
    ...
    assert chat.chat_name == ChatName2(name="Space Rocket")
...
def test_parse_chat_file_u200e_and_tilde_handling(tmp_path: Path) -> None:
