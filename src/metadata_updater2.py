"""
This module handles updating metadata JSON files in the output directory for ChatData2.
"""

import os

from src.chat_data2 import ChatData2


def update_metadata2(chat_data: ChatData2, output_dir: str) -> None:
    """
