    ...
    for line in lines:
        ...
        if timestamp_match and year_match and sender_match and content_match:
            ...
            if media_match:
                ...
                media = MediaReference(size=0, input_path=media_file, output_path=f"media/{media_file}")
            ...
            message = Message(timestamp=timestamp, sender=sender, content=content, year=year, media=media, input_file=file_path)
